...
const chargeDataWpp = async (page, docType, period, appliesTo, documentForCharge) => {
    ...
    await page.type('input#react-select-2-input', docType);//Le pasamos la primera posición de la doco divida por fecha
    ...
    if(period && divDatePicker){
        ...
        await page.type('div.react-datepicker-wrapper div input', period)
